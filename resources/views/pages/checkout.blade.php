                        ...
                        <div class="card card-details">
                                    ...
                                    <tbody>
                                        @forelse ($item->details as $detail)
                                            <tr>
                                                ...
                                                <td class="align-middle"><a href="{{ route('checkout-remove', $detail->id) }}"><img src="{{ url('frontend/images/ic_remove.png') }}"></a></td>
                                            </tr>
                                        @empty
                                            <tr>
                            ...
                            <div class="member mt-3">
                                ...
                                <form class="form-inline" action="{{ route('checkout-create', $item->id) }}" method="POST">
                                    ...
                                    <input type="text" name="nationality" class="form-control mb-2 mr-sm-2" style="width: 50px" placeholder="Nationality" id="nationality" required>
                                    ...
                                    <div class="input-group mb-2 mr-sm-2">
                                        <input type="text" class="form-control datepicker" style="width: 160px" name="doe_passport" id="doe_passport" placeholder="DOE Passport">
                                    </div>
                            ...
                            <table class="trip-information">
                                ...
                                <tr>
                                    ...
                                    <td width="50%" class="text-right text-total">
                                        ...
                                        {{-- fungsi mt_rand() untuk membuat random kode unik --}}
                                        {{ mt_rand(0,99) }}
                                        </span>
                                    </td>
                                </tr>
